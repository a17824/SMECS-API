...
var receiveAlert = require('./alerts/sendingReceiving/5.receiveAlert.js');
...
/* ADD USERS. ---------------------------------------------------*/
router.get('/users/addUser', auth.simpleAuth, auth.requireLogin, users.add, function(req, res) {
});
router.post('/users/addUser', auth.simpleAuth, auth.requireLogin, users.addPost, function(req, res) {
});
...
/* All Alerts -------------------------------*/
router.get('/alerts/receiving/receiveAlert/:id', auth.simpleAuth, auth.requireLogin, receiveAlert.showAlertReceived, function(req, res, next) {});

/* Request Assistance (ALERT 14)-------------------------------*/
router.post('/alerts/receiving/receiveAlert', auth.simpleAuth, auth.requireLogin, receiveAlert.postRequestAssistance, function(req, res) {});
