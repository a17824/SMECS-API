...
module.exports.saveAlertInfoStudent = function(req, res, tempAlert) {
    //checkStudentPhotoExists------------------
    if (tempAlert.studentPhoto == ''){  //if student photo don't exist on database
        tempAlert.studentPhoto = 'photoNotAvailable.bmp';
    }
    //---------- end of checkStudentPhotoExists

    //saveStudentElements------------------
    models.AlertSentInfo.findById({'_id': tempAlert._id}, function(error, alertUpdate) {
        alertUpdate.studentName = tempAlert.studentName;
        alertUpdate.studentPhoto = tempAlert._id + '_' + tempAlert.studentPhoto;
        alertUpdate.save();
    });
    //---------- end of saveStudentElements
