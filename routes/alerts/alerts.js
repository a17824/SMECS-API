...
module.exports.create = function(req, res) {
    async.parallel([
        ...
        var streamSort = models.Alerts.find().sort({"sortID":1}).stream();
        ...
        var stream = models.Alerts.find().sort({"sortID":1}).stream();
...
module.exports.update = function(req, res) {
    ...
    async.parallel([
        ...
        var stream = models.Alerts.find().sort({"alertID":1}).stream();
        stream.on('data', function (doc) {
            array.push(doc.alertID);
